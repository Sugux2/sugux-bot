...
# --- Мини-сервер, чтобы хостинг не спал ---
app = Flask('')

@app.route('/')
def home():
    return "Бот Sugux активен!"
...
class MyBot(BaseBot):
    # Тот самый список на 200 анимаций
    emotes = [
    ...
    async def on_start(self, session_metadata):
        print("✅ Бот онлайн и готов!")

    async def on_user_join(self, user: User, position: Position):
        await self.highrise.chat(f"Привет, {user.username}! Напиши число от 0 до 199.")
